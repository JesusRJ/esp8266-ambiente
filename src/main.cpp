...
void setup() {
  ...
  if(!wifiManager.autoConnect("NodeMCU","15002000"))                   //wifiManager.autoConnect("AP-NAME", "AP-PASSWORD"); (OR) wifiManager.autoConnect("AP-NAME"); only ID no password (OR) wifiManager.autoConnect(); this will generate a ID by itself
  {
...
void loop() 
{
  int analogValue = analogRead(outputpin);
  {
    ...
    String PostValue = "{\"device_id\":  88547398734432650000, \"slave_id\": 2";
